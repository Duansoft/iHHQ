            ...
            <div class="panel panel-white">
                ...
                <table class="table table-overview">
                    ...
                    @foreach($files as $file)
                        <tr>
                            <td>
                                <a href="{{ url('admin/files/' . $file->file_id) . '/detail' }}">
                            ...
                            <td>
                                <span class="no-margin">RM{{$file->outstanding_amount - $file->paid_amount}}
                                    <small class="display-block text-warning text-size-small">Due</small>
                                </span>
                            </td>
