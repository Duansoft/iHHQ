...
class File extends Model
{
    ...
    protected $fillable = ['file_ref', 'category_id', 'sub_category_id', 'department_id', 'project_name', 'tags',
        'subject_matter', 'subject_description', 'contact_name', 'contact', 'contact_email',
        'billplz_collection_id' ,'currency', 'status', 'percent', 'outstanding_amount', 'paid_amount',  'created_by', 'updated_by'];
